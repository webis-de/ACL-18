...
public class ChicksOnTheRightWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "Chicks On The Right";
  ...
  private String getAuthor(Document jsoupDocument) {
    return jsoupDocument.select("a.o-article__author-name").text();
  }

  private String getTitle(Document jsoupDocument) {
    return jsoupDocument.select("h2.o-article__title").text();
  }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://www.chicksontheright.com/");
  }
}
