...
public class DonaldTrumpNewsWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "Donald Trump News";
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://donaldtrumpnews.co/");
	}
}
