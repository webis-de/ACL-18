...
public class SoundcloudWrapper extends Wrapper {
	...
	private String getAuthor(Document jsoupDocument) {
		return jsoupDocument.select("div.soundTitle__usernameHeroContainer a").text();
	}
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("https://soundcloud.com/");
	}
}
