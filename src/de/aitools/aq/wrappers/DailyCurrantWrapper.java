...
public class DailyCurrantWrapper extends Wrapper {
	...
	private Document filter(Document jsoupDocument) {
		for(Element element : jsoupDocument.select("div#lower-footer"))
		{
			element.remove();
		}
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://dailycurrant.com/");
	}
}
