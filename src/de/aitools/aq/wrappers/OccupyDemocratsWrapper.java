...
public class OccupyDemocratsWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "Occupy Democrats";
  ...
  private String getAuthor(Document jsoupDocument) {
    return jsoupDocument.select("span.author-name.vcard.fn a").text();
  }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://occupydemocrats.com/");
  }
}
