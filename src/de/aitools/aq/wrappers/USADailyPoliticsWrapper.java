...
public class USADailyPoliticsWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "USA Daily Politics";
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://usadailypolitics.com/");
	}
}
