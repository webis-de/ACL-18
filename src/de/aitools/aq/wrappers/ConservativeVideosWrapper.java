...
public class ConservativeVideosWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "Conservative Videos";
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://conservativevideos.com/");
  }
}
