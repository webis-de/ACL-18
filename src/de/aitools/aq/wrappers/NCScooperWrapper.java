...
public class NCScooperWrapper extends Wrapper {
	...
	private String getAuthor(Document jsoupDocument) {
		return jsoupDocument.select("span.entry-author-name").text();
	}
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("https://www.ncscooper.com/");
	}
}
