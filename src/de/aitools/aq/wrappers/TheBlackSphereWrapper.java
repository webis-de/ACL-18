...
public class TheBlackSphereWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "The Black Sphere";
  ...
  private String getAuthor(Document jsoupDocument) {
    return jsoupDocument.select("span.author.vcard a").text();
  }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://theblacksphere.net/");
  }
}
