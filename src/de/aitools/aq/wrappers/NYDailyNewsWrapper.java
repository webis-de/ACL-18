...
public class NYDailyNewsWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "New York Daily News";
	...
	private String getAuthor(Document jsoupDocument) {
		return jsoupDocument.select("div.ra-byline a").first().text();
	}
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://www.nydailynews.com/");
	}
}
