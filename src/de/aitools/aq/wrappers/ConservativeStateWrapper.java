...
public class ConservativeStateWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "Conservative State";
  ...
  private String getAuthor(Document jsoupDocument) {
    return "Conservative State, " + jsoupDocument.select("span.fn a").text();
  }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://conservativestate.com/");
  }
}
