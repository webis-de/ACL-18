...
public class ConservativeByteWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "Conservative Byte";
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://conservativebyte.com/");
	}
}
