...
public class ConservativeTribuneWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "Conservative Tribune";
	...
	private String getAuthor(Document jsoupDocument) {
		Elements ele = jsoupDocument.getElementsByAttributeValue("name", "author");
	...
	private Document filter(Document jsoupDocument) {
		for(Element element : jsoupDocument.select("div.title-area,"
				+ "p.ad-notice-small,"
				+ "div#easc-modal-wrap,"
				+ "div.copyright,"
				+ "div#respond,"
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://conservativetribune.com/");
	}
}
