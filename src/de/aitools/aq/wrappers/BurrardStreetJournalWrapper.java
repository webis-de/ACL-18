...
public class BurrardStreetJournalWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "Burrard Street Journal";
    String orientation = "satire";
  ...
  private String getAuthor(Document jsoupDocument) {
    return jsoupDocument.select("div.td-post-author-name a").text();
  }  
  ...
  private Document filter(Document jsoupDocument) {
    for(Element element : jsoupDocument.select("p.essb-subscribe-form-content-text,"
        + "p.essb-subscribe-form-content-success.essb-subscribe-form-result-message,"
        + "p.essb-subscribe-form-content-error.essb-subscribe-form-result-message,"
        + "p.essb-subscribe-form-content-footer"))
    {
      element.remove();
    }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("http://www.burrardstreetjournal.com/");
  }
}
