...
public class OpposingViewsWrapper extends Wrapper {
	...
	private String getAuthor(Document jsoupDocument) {
		return jsoupDocument.select("div.date span span a").text();
	}
	...
	public boolean isValidUri(String targetUri) {
		if(targetUri.contains("http://www.opposingviews.com/") 
				|| targetUri.contains("https://www.opposingviews.com/"))
			return true;
		else
			return false;
	}
