...
public class UnitedMediaPublishingWrapper extends Wrapper {
	...
	public Article parse(Document jsoupDocument) {
		...
		String portal = "United Media Publishing";
	...
	private Document filter(Document jsoupDocument) {
		for(Element element : jsoupDocument.select("p.meta post-meta,"
				+ "ol.commentlist,"
				+ "div#respond,"
				+ "footer,"
				+ "div.copyright-wrap"))
	...
	public boolean isValidUri(String targetUri) {
		return targetUri.contains("http://unitedmediapublishing.com/");
	}
}
